...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
    ...
    F.prototype.config = {
        ...
        autoSort: !0,
        text: {
            none: systemLanguage["com.skyeye.noData"][languageType]
        }
    },
        ...
        F.prototype.renderToolbar = function() {
            ...
            "object" == typeof a.defaultToolbar && layui.each(a.defaultToolbar, function(e, t) {
                var i = r[t];
                i && d.push('<div class="layui-inline" title="' + i.title + '" lay-event="' + i.layEvent + '"><i class="' + i.icon + '"></i></div>')
            }),
                    ...
                    t.ajax({
                        ...
                        error: function(XMLHttpRequest, e, t) {
                            ...
                            if(sessionstatus == "TIMEOUT") { //超时跳转
                                ...
                                i.layMain.html('<div class="' + f + '">' + systemLanguage["com.skyeye.permission"][languageType] + '：' + t + "</div>"),
                                    i.renderForm(),
                                    i.setColsWidth();
                            }
                        }
        ...
        d.exportFile = function(id, data, type){
            var that = this;

            data = data || d.clearCacheKey(d.cache[id]);
            type = type || 'csv';
            ...
            alink.href = 'data:'+ textType +';charset=utf-8,\ufeff'+ encodeURIComponent(function(){
                ...
                layui.each(data, function(i1, item1){
                    ...
                    if(typeof id === 'object'){ //如果 id 参数直接为表头数据
                        ...
                        d.eachCols(id, function(i3, item3){
