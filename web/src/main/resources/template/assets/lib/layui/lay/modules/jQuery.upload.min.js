                    ...
                    if (["png", "jpg", "jpeg", "gif", "bmp"].indexOf(ty) >= 0) {
                    	if(options.uploadType == '1'){
                    		h = $("<li class='item success'></li>").append(g).append(typeof D == "function" ? E : "")
                    			.data("url", fileBasePath + "/images/upload/smpropic/" + p[s]).attr("data-filename", c(p[s])).css("background-image", "url('" + fileBasePath + "/images/upload/smpropic/" + p[s] + "')").insertBefore(A);
                    	}else{
                    		h = $("<li class='item success'></li>").append(g).append(typeof D == "function" ? E : "")
                    			.data("url", p[s]).attr("data-filename", c(p[s])).css("background-image", "url('" + fileBasePath + p[s] + "')").insertBefore(A);
                    	}
                    }else{
                        h = $("<li class=\"item success\" data-filename=\"YPCn1FUBacGJOuYKb6\">" + k(ty)+ '<div class="filename">' + ty + '</div>' + "</li>")
                        	.data("url", p[s]).insertBefore(A);
                    }
                    h.attr("oldurl", p[s]);
