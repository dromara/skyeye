layui.define(["jquery"], function(exports) {
			...
			return function(e) {
				...
				var a = function() {
					function e(t) {
						...
						! function(e, t) {
							if(!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
						}(this, e), this.player = t, [].concat(function(e) {
							if(Array.isArray(e)) {
				...
				var l = function() {
					function e(t) {
						...
						! function(e, t) {
							...
							n.setAutoHide()
						})), this.initPlayButton(), this.initThumbnails(), this.initPlayedBar(), this.initFullButton(), this.initQualityButton(), this.initScreenshotButton(), this.initSubtitleButton(), a.default.isMobile || this.initVolumeButton()
					}
					return i(e, [{
						key: "initPlayButton",
						value: function() {
						...
						value: function() {
							...
							this.player.template.playedBarWrap.addEventListener(a.default.nameMap.dragStart, function() {
								...
								if(e.player.video.duration) {
									...
									a.default.isMobile && e.thumbnails && e.thumbnails.show(), e.thumbnails && e.thumbnails.move(i), e.player.template.playedBarTime.style.left = i - 20 + "px", e.player.template.playedBarTime.innerText = a.default.secondToTime(o), e.player.template.playedBarTime.classList.remove("hidden")
								}
						...
						value: function() {
							...
							this.player.template.volumeBarWrapWrap.addEventListener("click", function(t) {
								...
								e.player.video.muted ? (e.player.video.muted = !1, e.player.switchVolumeIcon(), e.player.bar.set("volume", e.player.volume(), "width")) : (e.player.video.muted = !0, e.player.template.volumeIcon.innerHTML = s.default.volumeOff, e.player.bar.set("volume", 0, "width"))
							})
						}
					}, {
				...
				var r = function() {
					function e(t) {
						...
						this.player.container.addEventListener("fullscreenchange", i), this.player.container.addEventListener("mozfullscreenchange", i), this.player.container.addEventListener("webkitfullscreenchange", i)
					}
					return a(e, [{
						key: "isFullScreen",
						value: function() {
						...
						value: function(e) {
							...
							if(this.showing) {
								...
								for(var u = document.createDocumentFragment(), d = function(i) {
										e[i].type || (e[i].type = "right"), e[i].color || (e[i].color = "#fff");
										var o = document.createElement("div");
										o.classList.add("dplayer-danmaku-item"), o.classList.add("dplayer-danmaku-" + e[i].type), e[i].border ? o.innerHTML = '<span style="border:' + e[i].border + '">' + e[i].text + "</span>" : o.innerHTML = e[i].text, o.style.opacity = t._opacity, o.style.color = e[i].color, o.addEventListener("animationend", function() {
				...
				o.nextTick = function(e) {
					...
					u.push(new m(e, t)), 1 !== u.length || d || l(y)
				...
				}, n(45), t.setImmediate = setImmediate, t.clearImmediate = clearImmediate
			}, function(e, t, n) {
				"use strict";
				(function(e) {
					Object.defineProperty(t, "__esModule", {
					...
					function d(e, t) {
						try {
							...
							if(t && ("object" === (void 0 === t ? "undefined" : a(t)) || "function" == typeof t)) {
								...
								if("function" == typeof n) return void y((i = n, o = t, function() {
									i.apply(o, arguments)
								}), e)
							}
					...
					}, c.prototype.finally = s.default, c.all = function(e) {
							...
							function s(e, r) {
								try {
									if(r && ("object" === (void 0 === r ? "undefined" : a(r)) || "function" == typeof r)) {
										var l = r.then;
										if("function" == typeof l) return void l.call(r, function(t) {
											s(e, t)
										}, n)
									}
									i[e] = r, 0 == --o && t(i)
					...
					q = function() {
						function e(t) {
							...
							! function(e, t) {
								...
								events: this.events
							}), this.comment = new k.default(this)), this.setting = new b.default(this), document.addEventListener("click", function() {
								n.focus = !1
							}, !0), this.container.addEventListener("click", function() {
								n.focus = !0
							}, !0), this.paused = !0, this.timer = new f.default(this), this.hotkey = new w.default(this), this.contextmenu = new x.default(this), this.initVideo(this.video, this.quality && this.quality.type || this.options.video.type), this.infoPanel = new S.default(this), !this.danmaku && this.options.autoplay && this.play(), M++, _.push(this)
						}
						return i(e, [{
							key: "seek",
							value: function(e) {
							...
							value: function() {
								...
								if(this.paused = !1, this.video.paused && this.bezel.switch(c.default.play), this.template.playButton.innerHTML = c.default.pause, a.default.resolve(this.video.play()).catch(function() {
									...
									for(var t = 0; t < _.length; t++) this !== _[t] && _[t].pause()
							}
						}, {
							key: "pause",
							value: function() {
							...
							value: function(e, t) {
								...
								this.initMSE(e, t), this.on("durationchange", function() {
									...
									n.bar.set("played", 1, "width"), n.setting.loop ? (n.seek(0), e.play()) : n.pause(), n.danmaku && (n.danmaku.danIndex = 0)
								...
								this.volume(this.user.get("volume"), !0, !0), this.options.subtitle && (this.subtitle = new y.default(this.template.subtitle, this.video, this.options.subtitle, this.events), this.user.get("subtitle") || this.subtitle.hide())
							}
						}, {
							key: "switchQuality",
							value: function(e) {
							...
							key: "destroy",
							value: function() {
								_.splice(_.indexOf(this), 1), this.pause(), this.controller.destroy(), this.timer.destroy(), this.video.src = "", this.container.innerHTML = "", this.events.trigger("destroy")
							}
						}], [{
							key: "version",
							get: function() {
	...
	layui.link(basePath + '../../lib/layui/lay/modules/dplayer/DPlayer.min.css');
