...
layui.define(function(exports){
  ...
  Class.prototype.view = function(){
    ...
    ,views = {
      ...
      //数据总数
      ,count: '<span class="layui-laypage-count">' + systemLanguage["com.skyeye.all"][languageType] + ' '+ config.count +' ' + systemLanguage["com.skyeye.total"][languageType] + '</span>'
      ...
      ,limit: function(){
        ...
        layui.each(config.limits, function(index, item){
          options.push(
            ...
            +'>'+ item +' ' + systemLanguage["com.skyeye.totalPage"][languageType] + '</option>'
          );
        });
      ...
      //跳页区域
      ,skip: function(){
        return ['<span class="layui-laypage-skip">', systemLanguage["com.skyeye.toThe"][languageType]
          ,'<input type="text" min="1" value="'+ config.curr +'" class="layui-input">',
          systemLanguage["com.skyeye.page2"][languageType]
          ,'<button type="button" class="layui-laypage-btn">', systemLanguage["com.skyeye.determine"][languageType], 
          '</button>'
        ,'</span>'].join('');
      }()
    };
