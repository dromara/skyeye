...
layui.define('jquery', function (exports) {
    ...
    var $ = layui.$,
        ...
        THIS = 'layui-this',
        SHOW = 'layui-show',
        customDefaultPafeShowId = "#contentPage",
        Element = function () {
            this.config = {};
        };
    ...
    Element.prototype.tabAdd = function (filter, options) {
        var TITLE = '.layui-tab-title',
            ...
            contElem = $(customDefaultPafeShowId).length > 0 ? $(customDefaultPafeShowId) : tabElem.children('.layui-tab-content'),
    ...
    var NAV_ELEM = '.layui-nav',
        ...
        call = {
            ...
            tabClick: function (e, index, liElem, options) {
                ...
                var contentP = $(customDefaultPafeShowId).length > 0 ? $(customDefaultPafeShowId) : parents.children('.layui-tab-content');
                var item = options.bodyElem ? $(options.bodyElem) : contentP.children('.layui-tab-item'),
                    elemA = othis.find('a'),
            ...
            tabDelete: function (e, othis) {
                ...
                var contentP = $(customDefaultPafeShowId).length > 0 ? $(customDefaultPafeShowId) :
                    $(this).parents(".layui-tab").eq(0).find('.layui-tab-content');
                var item = contentP.children('.layui-tab-item'),
                    filter = parents.attr('lay-filter');
            ...
            tabAuto: function () {
                ...
                $('.layui-tab').each(function () {
                    ...
                    var contentP = $(customDefaultPafeShowId).length > 0 ? $(customDefaultPafeShowId) : othis.children('.layui-tab-content');
                    var item = contentP.children('.layui-tab-item'),
