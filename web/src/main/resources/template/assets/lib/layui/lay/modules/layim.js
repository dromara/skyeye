...
layui.define(["layer", "laytpl", "upload"], function(i) {
	...
	var u = function(i) {
			...
			return i = i || {}, 
					...
					'<img src="' + fileBasePath + '{{ data.avatar }}"><span>{{ data.username||data.groupname||data.name }}</span><p>{{ data.remark||data.sign||"" }}</p></li>',
	...
	var x, b, w, k, C, S = function(i, a, n) {
		...
		ei = {
			...
			about: function() {
				t.alert("版本： " + a + '<br>版权所有：<a href="https://gitee.com/doc_wei01/skyeye" target="_blank">https://gitee.com/doc_wei01/skyeye</a>', {
					title: "关于OA智能化办公系统",
					shade: !1
				})
			},
			...
			groupMembers: function(i, a) {//获取群组成员
				...
				i.data("down") ? l() : (n.html("&#xe619;"), i.data("down", !0), ei.groupMembers.index = t.tips('<ul class="layim-members-list"></ul>', i, {
					...
					success: function(a) {
						var t = j.base.members || {},//群组成员（不包含群主）
							n = O(),
