...
var commonHtml = {
    ...
    'dsFormPage': `<div class="layui-form-item layui-col-xs12">
                        ...
                        <div class="layui-input-block input-add-icon">
                            ...
                            <i class="fa fa-plus-circle input-icon chooseBtn"></i>
                        </div>
                    </div>`,
    'dsFormReportPage': `<div class="layui-form-item layui-col-xs12">
                        <label class="layui-form-label">报表视图<i class="red">*</i></label>
                        <div class="layui-input-block input-add-icon">
                            <input type="text" id="pageUrl" name="pageUrl" placeholder="请选择报表视图" win-verify="required" class="layui-input" readonly="readonly"/>
                            <i class="fa fa-plus-circle input-icon chooseBtn"></i>
                        </div>
                    </div>`,
