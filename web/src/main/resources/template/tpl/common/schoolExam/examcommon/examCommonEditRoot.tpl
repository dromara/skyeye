...
<div id="quRadioItem" class="modelHtml">
	<input type="radio" name="radioName{{checkNameIn}}">
...
<table class="modelHtml">
	<tr id="mFillblankTableModel">
		...
		<td>
			<input type="text" style="width:200px; padding:5px;" class="multiFillBlank">
		</td>
	</tr>
</table>
<table class="modelHtml">
...
<div id="dwCommonEditRoot">
	<div class="dwCommonEdit">
		<ul class="dwComEditMenuUl">
			<li>
				<a href="javascript:;" class="SeniorEdit"><i class="menu_edit2_icon"></i><language showName="com.skyeye.editBtn"></language></a>
			</li>
