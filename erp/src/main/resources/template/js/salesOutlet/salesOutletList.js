...
layui.config({
    ...
    table.render({
        ...
        elem: '#messageTable',
        method: 'post',
        url: sysMainMation.erpBasePath + 'salesoutlet001',
        ...
        cols: [[
            ...
            { field: 'holderMation', title: '客户', align: 'left', rowspan: '2', width: 150, templet: function (d) {
    ...
    $("body").on("click", "#addBean", function() {
        _openNewWindows({
            url:  systemCommonUtil.getUrl('FP2023042700001', null),
	...
	function edit(data) {
		_openNewWindows({
            url:  systemCommonUtil.getUrl('FP2023042700002&id=' + data.id, null),
	...
	function details(data) {
		_openNewWindows({
            url:  systemCommonUtil.getUrl('FP2023042700003&id=' + data.id, null),
