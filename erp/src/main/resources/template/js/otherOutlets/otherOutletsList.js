...
layui.config({
    ...
    table.render({
        ...
        elem: '#messageTable',
        method: 'post',
        url: sysMainMation.erpBasePath + 'otheroutlets001',
        ...
        cols: [[
            ...
            { field: 'oddNumber', title: '单据编号', align: 'left', width: 200, rowspan: '2', templet: function (d) {
    ...
    $("body").on("click", "#addBean", function() {
        _openNewWindows({
            url:  systemCommonUtil.getUrl('FP2023042700009', null),
