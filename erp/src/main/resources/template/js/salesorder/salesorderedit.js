...
layui.config({
	...
	function initDataShow(){
		AjaxPostUtil.request({url: reqBasePath + "salesorder004", params: {rowId: parent.rowId}, type: 'json', method: "GET", callback: function(json) {
	...
	function saveData(subType, approvalId){
		...
		AjaxPostUtil.request({url: reqBasePath + "salesorder005", params: params, type: 'json', method: "PUT", callback: function(json) {
			if(json.returnCode == 0) {
