...
layui.config({
    ...
    table.render({
        ...
        cols: [[
            ...
            { field: 'oddNumber', title: '单据编号', rowspan: '2', align: 'left', width: 250, templet: function (d) {
            ...
            { field: 'fromTypeId', title: '来源类型', width: 150, templet: function (d) {
                    return skyeyeClassEnumUtil.getEnumDataNameByCodeAndKey("sealReturnFromType", 'id', d.fromTypeId, 'name');
                }},
