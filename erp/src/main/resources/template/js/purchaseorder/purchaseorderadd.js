...
layui.config({
	...
	// 获取单据提交类型
	var submitType = erpOrderUtil.getSubmitTypeByKey(systemOrderType["purchaseOrder"]["key"]);
	...
	// 加载动态表单
	dsFormUtil.loadPageByCode("dsFormShow", sysDsFormWithCodeType["purchaseOrder"]["key"], null);
