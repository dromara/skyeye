...
layui.config({
    ...
    table.render({
        ...
        elem: '#messageTable',
        method: 'post',
        url: sysMainMation.erpBasePath + 'assemblysheet001',
    ...
    $("body").on("click", "#addBean", function() {
        _openNewWindows({
            url: systemCommonUtil.getUrl('FP2023042800001', null),
	...
	function edit(data) {
		_openNewWindows({
            url: systemCommonUtil.getUrl('FP2023042800002&id=' + data.id, null),
	...
	function details(data) {
		_openNewWindows({
            url: systemCommonUtil.getUrl('FP2023042800003&id=' + data.id, null),
