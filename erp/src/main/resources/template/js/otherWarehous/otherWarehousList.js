...
layui.config({
    ...
    table.render({
        ...
        elem: '#messageTable',
        method: 'post',
        url: sysMainMation.erpBasePath + 'otherwarehous001',
    ...
    $("body").on("click", "#addBean", function() {
        _openNewWindows({
            url:  systemCommonUtil.getUrl('FP2023042700013', null),
    ...
    function edit(data) {
        _openNewWindows({
            url:  systemCommonUtil.getUrl('FP2023042700014&id=' + data.id, null),
	...
	function details(data) {
		_openNewWindows({
            url:  systemCommonUtil.getUrl('FP2023042700015&id=' + data.id, null),
