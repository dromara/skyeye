...
layui.config({
	...
	// 获取单据提交类型
	var submitType = erpOrderUtil.getSubmitTypeByOrderType(systemOrderType["putIsSalesReturns"]["orderType"]);
	...
	// 加载动态表单
	dsFormUtil.loadPageByCode("dsFormShow", sysDsFormWithCodeType["putIsSalesReturns"]["code"], null);
	...
	function saveData(subType, approvalId){
		...
		AjaxPostUtil.request({url: flowableBasePath + "salesreturns002", params: params, type: 'json', method: "POST", callback: function(json) {
