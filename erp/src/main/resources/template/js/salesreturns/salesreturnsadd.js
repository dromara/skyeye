...
layui.config({
	...
	// 获取单据提交类型
	var submitType = erpOrderUtil.getSubmitTypeByKey(systemOrderType["putIsSalesReturns"]["key"]);
	...
	// 加载动态表单
	dsFormUtil.loadPageByCode("dsFormShow", sysDsFormWithCodeType["putIsSalesReturns"]["key"], null);
