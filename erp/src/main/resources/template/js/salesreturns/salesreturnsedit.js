...
layui.config({
	...
	function initDataShow(){
		AjaxPostUtil.request({url: reqBasePath + "salesreturns003", params: {rowId: parent.rowId}, type: 'json', method: "GET", callback: function(json) {
	...
	function saveData(subType, approvalId){
		...
		AjaxPostUtil.request({url: reqBasePath + "salesreturns004", params: params, type: 'json', method: "PUT", callback: function(json) {
			if(json.returnCode == 0) {
