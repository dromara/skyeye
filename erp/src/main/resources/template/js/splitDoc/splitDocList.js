...
layui.config({
    ...
    var $ = layui.$,
        form = layui.form,
        table = layui.table;
    var serviceClassName = sysServiceMation["splitListOrder"]["key"];
    ...
    table.render({
        ...
        elem: '#messageTable',
        method: 'post',
        url: sysMainMation.erpBasePath + 'splitlist001',
    ...
    $("body").on("click", "#addBean", function() {
        _openNewWindows({
            url:  systemCommonUtil.getUrl('FP2023042700017', null),
	...
	function edit(data) {
		_openNewWindows({
            url:  systemCommonUtil.getUrl('FP2023042700018&id=' + data.id, null),
	...
	function details(data) {
		_openNewWindows({
            url:  systemCommonUtil.getUrl('FP2023042700019&id=' + data.id, null),
