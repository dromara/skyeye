...
layui.config({
    ...
    // 零售出库转仓库出库
    AjaxPostUtil.request({url: sysMainMation.erpBasePath + "queryRetailOutLetTransById", params: {id: id}, type: 'json', method: 'GET', callback: function (json) {
        let data = json.bean;
        // 仓库出库的【编辑布局】
        dsFormUtil.initEditPageForStatic('content', 'FP2024070100006', data, {
            ...
            saveData: function (params) {
                // 保存数据
                AjaxPostUtil.request({url: sysMainMation.erpBasePath + "insertRetailOutLetToTurnDepot", params: params, type: 'json', method: "POST", callback: function(json) {
