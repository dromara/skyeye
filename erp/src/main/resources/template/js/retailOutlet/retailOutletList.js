...
layui.config({
    ...
    table.render({
        ...
        elem: '#messageTable',
        method: 'post',
        url: sysMainMation.erpBasePath + 'retailoutlet001',
    ...
    $("body").on("click", "#addBean", function() {
        _openNewWindows({
            url:  systemCommonUtil.getUrl('FP2023042600001', null),
	...
	function edit(data) {
		_openNewWindows({
            url:  systemCommonUtil.getUrl('FP2023042600002&id=' + data.id, null),
	...
	function details(data) {
		_openNewWindows({
            url:  systemCommonUtil.getUrl('FP2023042600003&id=' + data.id, null),
