...
layui.config({
    ...
    table.on('tool(messageTable)', function (obj) {
        ...
        if (layEvent === 'delete') { //删除
            ...
            erpOrderUtil.revokeOrderMation(data.processInstanceId, systemOrderType["putIsOthers"]["key"], function() {
                loadTable();
            });
        }
    });
	...
	function subExamine(data) {
        erpOrderUtil.submitOrderMation(data.id, systemOrderType["putIsOthers"]["key"], data.submitType, sysActivitiModel["putIsOthers"]["key"], function() {
            loadTable();
        });
    }
    ...
    function deletemember(data) {
        erpOrderUtil.deleteOrderMation(data.id, systemOrderType["putIsOthers"]["key"], function() {
            loadTable();
        });
    }
