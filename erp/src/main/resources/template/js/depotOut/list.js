...
layui.config({
    ...
    table.render({
        ...
        cols: [[
            ...
            { field: 'oddNumber', title: '出库单单号', rowspan: '2', align: 'left', width: 220, templet: function (d) {
            ...
            { field: 'createName', title: '申请人', rowspan: '2', width: 120 },
            { field: 'createTime', title: '申请时间', rowspan: '2', align: 'center', width: 150 },
