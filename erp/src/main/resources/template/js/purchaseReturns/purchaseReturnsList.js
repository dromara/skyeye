...
layui.config({
    ...
    table.render({
        ...
        elem: '#messageTable',
        method: 'post',
        url: sysMainMation.erpBasePath + 'purchasereturns001',
        ...
        cols: [[
            ...
            { field: 'fromTypeId', title: '来源类型', width: 150, templet: function (d) {
                return skyeyeClassEnumUtil.getEnumDataNameByCodeAndKey("purchaseReturnsFromType", 'id', d.fromTypeId, 'name');
            }},
    ...
    $("body").on("click", "#addBean", function() {
        _openNewWindows({
            url: systemCommonUtil.getUrl('FP2023042400001', null),
	...
	function edit(data) {
		_openNewWindows({
			url: systemCommonUtil.getUrl('FP2023042400002&id=' + data.id, null),
	...
	function details(data) {
		_openNewWindows({
			url: systemCommonUtil.getUrl('FP2023042400003&id=' + data.id, null),
