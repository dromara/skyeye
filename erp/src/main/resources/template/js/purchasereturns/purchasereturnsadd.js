...
layui.config({
	...
	// 加载动态表单
	dsFormUtil.loadPageByCode("dsFormShow", sysDsFormWithCodeType["outIsPurchaseReturns"]["code"]);
	...
	function saveData(subType, approvalId){
		...
		AjaxPostUtil.request({url: reqBasePath + "purchasereturns002", params: params, type: 'json', method: "POST", callback: function(json) {
