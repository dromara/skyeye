...
layui.config({
    ...
    table.on('tool(messageTable)', function (obj) {
        ...
        } else if (layEvent === 'turnRequisitionMaterialToOut') { //转领料出库
            turnRequisitionMaterialToOut(data);
    ...
    function del(data) {
        layer.confirm(systemLanguage["com.skyeye.deleteOperationMsg"][languageType], {icon: 3, title: systemLanguage["com.skyeye.deleteOperation"][languageType]}, function (index) {
            AjaxPostUtil.request({url: sysMainMation.erpBasePath + "deleteRequisitionMaterialById", params: {id: data.id}, type: 'json', method: 'DELETE', callback: function (json) {
