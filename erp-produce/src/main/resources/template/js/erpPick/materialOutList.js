...
layui.config({
    ...
    var $ = layui.$,
        form = layui.form,
        table = layui.table;
    var serviceClassName = sysServiceMation["materialOutList"]["key"];
    authBtn('1720705501263');//新增
    ...
    table.render({
        ...
        elem: '#messageTable',
        method: 'post',
        url: sysMainMation.erpBasePath + 'queryRequisitionOutLetList',
        ...
        cols: [[
            ...
            { field: 'fromTypeId', title: '来源类型', width: 150, templet: function (d) {
                    return skyeyeClassEnumUtil.getEnumDataNameByCodeAndKey("requisitionOutLetFromType", 'id', d.fromTypeId, 'name');
                }},
    ...
    $("body").on("click", "#addBean", function() {
        _openNewWindows({
            url: systemCommonUtil.getUrl('FP2024071200004', null),
            title: systemLanguage["com.skyeye.addPageTitle"][languageType],
            pageId: "materialOutListAdd",
            area: ['90vw', '90vh'],
    ...
    function edit(data) {
        _openNewWindows({
            url: systemCommonUtil.getUrl('FP2024071200005&id=' + data.id, null),
            title: systemLanguage["com.skyeye.editPageTitle"][languageType],
            pageId: "materialOutListEdit",
            area: ['90vw', '90vh'],
            callBack: function (refreshCode) {
                winui.window.msg(systemLanguage["com.skyeye.successfulOperation"][languageType], {icon: 1, time: 2000});
                loadTable();
    ...
    function details(data) {
        _openNewWindows({
            url: systemCommonUtil.getUrl('FP2024070100001&id=' + data.id, null),
            title: systemLanguage["com.skyeye.detailsPageTitle"][languageType],
            pageId: "materialOutListDetails",
            area: ['90vw', '90vh'],
            callBack: function (refreshCode) {
            }});
    }
