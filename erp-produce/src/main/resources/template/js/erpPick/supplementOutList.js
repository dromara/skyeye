...
layui.config({
    ...
    var $ = layui.$,
        form = layui.form,
        table = layui.table;
    var serviceClassName = sysServiceMation["supplementOutList"]["key"];
    authBtn('1720705670125');//新增
    //补料出库单
    table.render({
        id: 'messageTable',
        elem: '#messageTable',
        method: 'post',
        url: sysMainMation.erpBasePath + 'queryPatchOutLetList',
        ...
        cols: [[
            ...
            { field: 'fromTypeId', title: '来源类型', width: 150, templet: function (d) {
                    return skyeyeClassEnumUtil.getEnumDataNameByCodeAndKey("patchOutLetFromType", 'id', d.fromTypeId, 'name');
                }},
    ...
    $("body").on("click", "#addBean", function() {
        _openNewWindows({
            url: systemCommonUtil.getUrl('FP2024071200001', null),
            title: systemLanguage["com.skyeye.addPageTitle"][languageType],
            pageId: "supplementOutListAdd",
            area: ['90vw', '90vh'],
    ...
    function edit(data) {
        _openNewWindows({
            url: systemCommonUtil.getUrl('FP2024071200002&id=' + data.id, null),
            title: systemLanguage["com.skyeye.editPageTitle"][languageType],
            pageId: "supplementOutListEdit",
            area: ['90vw', '90vh'],
            callBack: function (refreshCode) {
                winui.window.msg(systemLanguage["com.skyeye.successfulOperation"][languageType], {icon: 1, time: 2000});
                loadTable();
    ...
    function details(data) {
        _openNewWindows({
            url: systemCommonUtil.getUrl('FP2024070100002&id=' + data.id, null),
            title: systemLanguage["com.skyeye.detailsPageTitle"][languageType],
            pageId: "supplementOutListDetails",
            area: ['90vw', '90vh'],
            callBack: function (refreshCode) {
            }});
    }
