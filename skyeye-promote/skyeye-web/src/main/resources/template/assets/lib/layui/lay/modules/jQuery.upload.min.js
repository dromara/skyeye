                ...
                if (s < B.num && p[s]) {
                    ...
                    if (["png", "jpg", "jpeg", "gif", "bmp"].indexOf(ty) >= 0) {
                    	if(options.uploadType == '1'){
                    		h = a("<li class='item success'></li>").append(g).append(typeof D == "function" ? E : "").data("url", p[s]).attr("data-filename", c(p[s])).css("background-image", "url('" + fileBasePath + "/assets/smpropic/" + p[s] + "')").insertBefore(A);
                    	}else{
                    ...
                    var i = l(G[F], function(K, J, I) {
                        ...
                        a.ajax({
                            ...
                            success: function(M) {
                                ...
                                if (M.returnCode == 0) {
                                	if(M.bean.type == '1'){
                                		J.addClass("success").append(g).append(typeof D == "function" ? E : "").data("url", fileBasePath + "\\assets\\smpropic\\" + M.bean.picUrl);
