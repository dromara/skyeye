...
/**
 * @ClassName: LicenceBorrowFactory
 * @Description: 证照借用申请工厂类
 * @author: skyeye云系列--卫志强
 * @date: 2021/7/24 23:00
 * @Copyright: 2021 https://gitee.com/doc_wei01/skyeye Inc. All rights reserved.
 * 注意：本内容仅限购买后使用.禁止私自外泄以及用于其他的商业目的
 */
public class LicenceBorrowFactory extends ActivitiFactory implements ActivitiFactoryResult {

    private LicenceApplyBorrowDao licenceApplyBorrowDao;

    public LicenceBorrowFactory(InputObject inputObject, OutputObject outputObject, String key) {
        super(inputObject, outputObject, key);
    }

    public LicenceBorrowFactory(String key) {
        super(key);
    }

    @Override
    protected void initChildObject() {
        this.licenceApplyBorrowDao = SpringUtils.getBean(LicenceApplyBorrowDao.class);
    }
    ...
    protected List<Map<String, Object>> queryWithActivitiListRunSql(Map<String, Object> inputParams) throws Exception {
        return licenceApplyBorrowDao.selectMyLicenceBorrowList(inputParams);
    }
    ...
    protected Map<String, Object> submitToActiviGetDate(String id) throws Exception {
        Map<String, Object> licenceBorrow = licenceApplyBorrowDao.queryLicenceBorrowMationById(id);
        // 获取证照信息
        List<Map<String, Object>> goods = licenceApplyBorrowDao.queryLicenceBorrowGoodsByUseId(id);
        licenceBorrow.put("goods", goods);
        // 获取附件信息
        licenceBorrow.put("enclosureInfo", sysEnclosureDao.queryEnclosureInfo(licenceBorrow.get("enclosureInfo").toString()));
        return licenceBorrow;
    }
    ...
    protected void submitToActiviSuccess(String id, String processInId) throws Exception {
        // 修改为审核中
        licenceApplyBorrowDao.updateLicenceBorrowStateISInAudit(id, processInId);
        // 借用单子单据状态修改为等待发放
        licenceApplyBorrowDao.updateLicenceBorrowGoodsStateISInAudit(id);
    }
    ...
    protected void revokeActiviSuccess(Map<String, Object> map) throws Exception {
        ...
        // 修改证照借用单状态
        licenceApplyBorrowDao.editLicenceBorrowToRevokeById(id);
        // 修改证照借用单关联的证照信息
        licenceApplyBorrowDao.editLicenceBorrowGoodsByUseId(id, 0);
    }
}
