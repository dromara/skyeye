...
layui.config({
	...
	AjaxPostUtil.request({url: reqBasePath + "assetarticles021", params: {rowId: parent.rowId}, type: 'json', callback: function(json) {
	...
	function saveData(subType, approvalId){
		...
		AjaxPostUtil.request({url: reqBasePath + "assetarticles022", params: params, type: 'json', callback: function(json) {
			if(json.returnCode == 0) {
