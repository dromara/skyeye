...
> 价格介绍：开源版只包含基础功能，架构不支持高并发，容易出现问题，如想使用，签订使用协议即可。商业版包含所有功能，一直在更新，价格也在随时变化，目前价格是六万(需要发票另外算)，负责半年的现有功能维护，提供开发文档、技术支持、疑难问题的解决方案，可根据需要进行功能整合（整合后费用跟着变化），一次性付费，全部源码。商业版包含的功能往下翻
