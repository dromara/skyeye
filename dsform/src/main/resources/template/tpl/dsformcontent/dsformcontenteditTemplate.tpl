{{#bean}}
	<div class="layui-form-item layui-col-xs12">
		<span class="hr-title" id="exexplaintodsformcontentTitle"></span><hr>
	</div>
	<div class="layui-form-item layui-col-xs12" id="exexplaintodsformcontentContent" style="padding: 0px 15px; font-size: 12px; color: grey; display: contents;">
    </div>
	<div class="layui-form-item layui-col-xs12">
