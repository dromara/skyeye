{{#bean}}
	<form class="layui-form" action="" id="showForm" autocomplete="off">
        ...
        <div class="layui-form-item" style="display: {{shareType}}">
            <label class="layui-form-label">提取码</label>
            <div class="layui-input-block">
                <input type="text" id="sharePassword" value="{{sharePassword}}" class="layui-input" readonly style="width: 50px;"/>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label"></label>
            <div class="layui-input-block">
                <button class="layui-btn layui-btn-normal" id="copyBtn" type="button" data-clipboard-text="">{{btnName}}</button>
            </div>
        </div>
     </form>
{{/bean}}