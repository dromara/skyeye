...
layui.config({
	...
	function initTable(){
		table.render({
		    ...
		    limit: 8,
		    cols: [[
		        { field: 'customName', title: '客户名称', align: 'left', width: 240 },
    ...
    function refreshTable(){
    	...
    	table.reloadData("messageTable", {page: {curr: 1}, where: {customName: $("#customName").val(), serviceType: $("#serviceType").val(), startTime: startTime, endTime: endTime}});
    }
