...
layui.config({
	...
	function initTable(){
		...
		table.render({
		    ...
		    elem: '#messageTable',
		    method: 'post',
		    url: flowableBasePath + 'sealseservicestatisforms004',
		    where: {productName: $("#productName").val(), startTime: startTime, endTime: endTime},
		    even: true,
		    page: true,
		    limits: [8, 16, 24, 32, 40, 48, 56],
		    limit: 8,
		    cols: [[
		        { field: 'productName', title: '设备名称', align: 'left', width: 240 },
