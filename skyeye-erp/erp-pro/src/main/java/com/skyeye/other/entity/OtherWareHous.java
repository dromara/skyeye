...
package com.skyeye.other.entity;
 ...
 */
@Data
@RedisCacheField(name = "erp:order:otherWareHous", cacheTime = RedisConstants.TOW_MONTH_SECONDS)
@TableName(value = "erp_depothead", autoResultMap = true)
@ApiModel("其他入库单实体类")
public class OtherWareHous extends ErpOrderHead {
