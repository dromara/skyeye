...
public class AllocationServiceImpl implements AllocationService{
	 ...
	 * 调拨单类型
	 */
	private String ORDER_TYPE = ErpConstants.DepoTheadSubType.ALLOCATION_FORM_ORDER.getType();
	...
	public void insertAllocationMation(InputObject inputObject, OutputObject outputObject) throws Exception {
		...
		if(ToolUtil.isJson(depotheadStr)){
			...
			depothead.put("subType", ORDER_TYPE);//调拨单
			...
			depothead.put("payType", "1");//付款类型-调拨单默认为1
			//合计金额
