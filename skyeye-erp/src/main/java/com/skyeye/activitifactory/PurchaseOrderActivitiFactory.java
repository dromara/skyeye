...
/**
 * @ClassName: PurchaseOrderFactory
 * @Description: 采购订单工作流工厂类
 * @author: skyeye云系列--卫志强
 * @date: 2021/8/15 21:34
 * @Copyright: 2021 https://gitee.com/doc_wei01/skyeye Inc. All rights reserved.
 * 注意：本内容仅限购买后使用.禁止私自外泄以及用于其他的商业目的
 */
public class PurchaseOrderActivitiFactory extends ActivitiFactory implements ActivitiFactoryResult {

    private ErpCommonService erpCommonService;

    private ErpCommonDao erpCommonDao;

    public PurchaseOrderActivitiFactory(InputObject inputObject, OutputObject outputObject, String key) {
        super(inputObject, outputObject, key);
    }

    public PurchaseOrderActivitiFactory(String key) {
        super(key);
    }
