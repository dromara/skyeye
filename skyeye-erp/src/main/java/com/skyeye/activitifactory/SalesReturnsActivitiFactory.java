...
/**
 * @ClassName: SalesReturnsActivitiFactory
 * @Description: 销售退货单工作流工厂类
 * @author: skyeye云系列--卫志强
 * @date: 2021/8/18 21:25
 * @Copyright: 2021 https://gitee.com/doc_wei01/skyeye Inc. All rights reserved.
 * 注意：本内容仅限购买后使用.禁止私自外泄以及用于其他的商业目的
 */
public class SalesReturnsActivitiFactory extends ActivitiFactory implements ActivitiFactoryResult {

    private ErpCommonService erpCommonService;

    private ErpCommonDao erpCommonDao;

    public SalesReturnsActivitiFactory(InputObject inputObject, OutputObject outputObject, String key) {
        super(inputObject, outputObject, key);
    }

    public SalesReturnsActivitiFactory(String key) {
        super(key);
    }
