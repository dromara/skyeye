 ...
 * @Description: 采购入库单工厂类
 * @author: skyeye云系列--卫志强
 * @date: 2021/7/9 22:03
 * @Copyright: 2021 https://gitee.com/doc_wei01/skyeye Inc. All rights reserved.
 * 注意：本内容仅限购买后使用.禁止私自外泄以及用于其他的商业目的
 */
public class PurchasePutFactory extends ErpOrderFactory implements ErpOrderFactoryResult {

    private PurchasePutDao purchasePutDao;

    private StoreHouseApprovalService storeHouseApprovalService;

    public PurchasePutFactory(InputObject inputObject, OutputObject outputObject, String orderType) {
        super(inputObject, outputObject, orderType);
        this.purchasePutDao = SpringUtils.getBean(PurchasePutDao.class);
    ...
    protected List<Map<String, Object>> queryOrderListSqlRun(Map<String, Object> params) throws Exception {
        return purchasePutDao.queryPurchasePutToList(params);
    }
