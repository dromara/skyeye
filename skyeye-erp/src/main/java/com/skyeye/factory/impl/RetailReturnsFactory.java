...
/**
 * @ClassName: RetailReturnsFactory
 * @Description: 零售退货单工厂类
 * @author: skyeye云系列--卫志强
 * @date: 2021/7/16 22:05
 * @Copyright: 2021 https://gitee.com/doc_wei01/skyeye Inc. All rights reserved.
 * 注意：本内容仅限购买后使用.禁止私自外泄以及用于其他的商业目的
 */
public class RetailReturnsFactory extends ErpOrderFactory implements ErpOrderFactoryResult {

    private RetailReturnsDao retailReturnsDao;

    private StoreHouseApprovalService storeHouseApprovalService;

    public RetailReturnsFactory(InputObject inputObject, OutputObject outputObject, String orderType) {
        super(inputObject, outputObject, orderType);
        this.retailReturnsDao = SpringUtils.getBean(RetailReturnsDao.class);
    ...
    protected List<Map<String, Object>> queryOrderListSqlRun(Map<String, Object> params) throws Exception {
        return retailReturnsDao.queryRetailReturnsToList(params);
    }
