...
/**
 * @ClassName: SalesOutLetFactory
 * @Description: 销售出库单工厂类
 * @author: skyeye云系列--卫志强
 * @date: 2021/7/15 22:34
 * @Copyright: 2021 https://gitee.com/doc_wei01/skyeye Inc. All rights reserved.
 * 注意：本内容仅限购买后使用.禁止私自外泄以及用于其他的商业目的
 */
public class SalesOutLetFactory extends ErpOrderFactory implements ErpOrderFactoryResult {
    ...
    public SalesOutLetFactory(InputObject inputObject, OutputObject outputObject, String orderType){
        super(inputObject, outputObject, orderType);
        this.salesOutLetDao = SpringUtils.getBean(SalesOutLetDao.class);
    ...
    protected List<Map<String, Object>> queryOrderListSqlRun(Map<String, Object> params) throws Exception {
        return salesOutLetDao.querySalesOutLetToList(params);
    }
