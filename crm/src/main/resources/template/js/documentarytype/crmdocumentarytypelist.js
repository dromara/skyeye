...
layui.config({
	...
	authBtn('1569378413835');
	table.render({
	    id: 'messageTable',
	    elem: '#messageTable',
	    method: 'post',
	    url: reqBasePath + 'crmdocumentarytype001',
	    ...
	    cols: [[
	        ...
	        { field: 'typeName', title: '类型名称', align: 'left', width: 200 },
	...
	$("body").on("click", "#addBean", function(){
    	_openNewWindows({
			url: "../../tpl/documentarytype/crmdocumentarytypeadd.html", 
			title: systemLanguage["com.skyeye.addPageTitle"][languageType],
			pageId: "crmdocumentarytypeadd",
			area: ['40vw', '40vh'],
	...
	function edit(data){
		rowId = data.id;
		_openNewWindows({
			url: "../../tpl/documentarytype/crmdocumentarytypeedit.html", 
			title: systemLanguage["com.skyeye.editPageTitle"][languageType],
			pageId: "crmdocumentarytypeedit",
			area: ['40vw', '40vh'],
			callBack: function(refreshCode){
                if (refreshCode == '0') {
                	winui.window.msg(systemLanguage["com.skyeye.successfulOperation"][languageType], {icon: 1,time: 2000});
	...
	function del(data, obj){
		layer.confirm(systemLanguage["com.skyeye.deleteOperationMsg"][languageType], {icon: 3, title: systemLanguage["com.skyeye.deleteOperation"][languageType]}, function(index){
			layer.close(index);
            AjaxPostUtil.request({url: reqBasePath + "crmdocumentarytype005", params: {rowId: data.id}, type: 'json', callback: function(json){
	...
	function up(data, obj){
		...
		layer.confirm(msg, {icon: 3, title: '类型上线'}, function (index) {
			layer.close(index);
            AjaxPostUtil.request({url: reqBasePath + "crmdocumentarytype006", params: {rowId: data.id}, type: 'json', callback: function(json){
    			if(json.returnCode == 0){
	...
	function down(data, obj){
		...
		layer.confirm(msg, {icon: 3, title: '类型下线'}, function (index) {
			layer.close(index);
            AjaxPostUtil.request({url: reqBasePath + "crmdocumentarytype007", params: {rowId: data.id}, type: 'json', callback: function(json){
    			if(json.returnCode == 0){
    ...
    exports('crmdocumentarytypelist', {});
});