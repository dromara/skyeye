...
layui.config({
	...
	layui.use(['form', 'layedit'], function (form) {
	    ...
	    AjaxPostUtil.request({url: reqBasePath + "opportunity016", params: {rowId: rowId}, type: 'json', callback: function(json){
	    ...
	    form.on('submit(formAddBean)', function (data) {
	        if (winui.verifyForm(data.elem)) {
    			...
    			AjaxPostUtil.request({url: reqBasePath + "opportunity014", params: params, type: 'json', callback: function(json){
    				if (json.returnCode == 0){
