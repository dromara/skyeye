...
layui.config({
	...
	layui.use(['form', 'layedit'], function (form) {
	    ...
	    AjaxPostUtil.request({url: flowableBasePath + "opportunity016", params: {rowId: rowId}, type: 'json', callback: function (json) {
	    ...
	    form.on('submit(formAddBean)', function (data) {
	        if (winui.verifyForm(data.elem)) {
        		var params = {
        			...
        			opportunityId: parent.rowId//商机id
        		};
    			...
    			AjaxPostUtil.request({url: flowableBasePath + "opportunity014", params: params, type: 'json', callback: function (json) {
