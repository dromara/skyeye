	...
	table.render({
		...
		cols: [[
			...
			{ field: 'childState', title: '合同产品状态', rowspan: '2', width: 150, templet: function (d) {
				return skyeyeClassEnumUtil.getEnumDataNameByCodeAndKey("crmContractChildStateEnum", 'id',d.childState, 'name');
			}},
