...
layui.config({
    ...
    layui.use(['form'], function (form) {
        ...
        form.on('submit(formEditBean)', function (data) {
            if (winui.verifyForm(data.elem)) {
                ...
                if(isNull(nodes)){
                    ...
                    var params = {
                        appMenuIds: JSON.stringify(menuIds),
                        id: id,
                        name: $("#name").html(),
                        remark: $("#remark").html(),
                    };

                    AjaxPostUtil.request({url: fileBasePath + "editTenantAppAppMenuById", params: params, type: 'json', callback: function (json) {
        ...
        AjaxPostUtil.request({url: fileBasePath + "queryTenantAppById", params: {id: id}, type: 'json', method: "GET", callback: function (json) {
                ...
                tree = fsTree.render({
                    id: "treeDemo",
                    url: fileBasePath + "queryTenantAppBandAppMenuList",
                    getTree: getTree,
                    checkEnable: true,
                    loadEnable: false,
                    showLine: false,
