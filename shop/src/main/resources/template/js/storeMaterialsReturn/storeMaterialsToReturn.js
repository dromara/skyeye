...
layui.config({
    ...
    AjaxPostUtil.request({url: sysMainMation.erpBasePath + "queryDepotOutTransStoreById", params: {id: id}, type: 'json', method: 'GET', callback: function (json) {
            let data = json.bean;
            // 门店物料退货的【编辑布局】
            dsFormUtil.initEditPageForStatic('content', 'FP2024073000002', data, {
                savePreParams: function (params) {
                    params.storeId=data.storeId
                },
                saveData: function (params) {
                    // 保存数据
                    AjaxPostUtil.request({url: sysMainMation.erpBasePath + "insertDepotOutToStoreSealsReturns", params: params, type: 'json', method: "POST", callback: function(json) {
