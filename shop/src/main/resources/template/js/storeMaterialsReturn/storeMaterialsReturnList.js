...
layui.config({
    ...
    var $ = layui.$,
        form = layui.form,
        table = layui.table;
    var serviceClassName = sysServiceMation["shopConfirmReturn"]["key"];
    ...
    table.render({
        ...
        elem: '#messageTable',
        method: 'post',
        url: sysMainMation.erpBasePath + 'queryShopConfirmReturnList',
    ...
    function edit(data) {
        _openNewWindows({
            url:  systemCommonUtil.getUrl('FP2024073000002&id=' + data.id, null),
            title: systemLanguage["com.skyeye.editPageTitle"][languageType],
            pageId: "storeMaterialsReturnEdit",
            area: ['90vw', '90vh'],
    ...
    function details(data) {
        _openNewWindows({
            url:  systemCommonUtil.getUrl('FP2024073000003&id=' + data.id, null),
            title: systemLanguage["com.skyeye.detailsPageTitle"][languageType],
            pageId: "storeMaterialsReturnDetails",
            area: ['90vw', '90vh'],
            callBack: function (refreshCode) {
            }});
    }
    ...
    exports('storeMaterialsReturnList', {});
});
