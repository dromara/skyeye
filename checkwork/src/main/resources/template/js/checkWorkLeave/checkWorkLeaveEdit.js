...
layui.config({
    ...
    AjaxPostUtil.request({url: reqBasePath + "checkworkleave004", params: {rowId: parent.rowId}, type: 'json', method: 'GET', callback: function(mation) {
    ...
    function saveData(subType, approvalId){
        ...
        AjaxPostUtil.request({url: reqBasePath + "checkworkleave005", params: params, type: 'json', method: 'PUT',  callback: function(json) {
            if(json.returnCode == 0) {
