...
layui.config({
	...
	reactProductionMin: '../layui/lay/modules/flowchart/react.production.min'
}).define(['jquery', 'reactProductionMin'], function (exports) {
	...
	exports('reactDomProductionMin', null);
});
