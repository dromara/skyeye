    ...
    layui.use(['form', 'tagEditor'], function(form) {
        ...
        function initDataToShow(){
        	// 供应商信息赋值
	 		supplierMation = {
	 			...
	 			supplierName: orderObject.bean.supplierName
	 		}
            $("#supplierName").val(orderObject.bean.supplierName);//来往单位
        ...
        form.on('submit(formEditBean)', function(data) {
            ...
            if(winui.verifyForm(data.elem)) {
                ...
                AjaxPostUtil.request({url: reqBasePath + "expenditure004", params: params, type: 'json', method: "PUT", callback: function(json) {
